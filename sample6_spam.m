...
%  After training the classifier, we evaluate it on a test set.
...
%  emails! The following code reads in one of the emails in spamSample1.txt, 
%  spamSample2.txt, emailSample1.txt and emailSample2.txt and then uses our 
