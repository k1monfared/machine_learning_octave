...
%  We start by implementing the feedforward part of the neural network that 
% returns the cost only. Then we verify that
%  our implementation is correct by verifying that we get the same cost
%  as us for the fixed debugging parameters.
%
fprintf('\nFeedforward Using Neural Network ...\n')

% Weight regularization parameter (we set this to 0 for now).
lambda = 0;
...
% implement the regularization with the cost.
%
...
%  Implment a two layer neural network that classifies digits. We start by
...
%  backpropagation algorithm for the neural network. Return the partial
